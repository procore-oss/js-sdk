...
var when_1 = require("ramda/src/when");
var not_1 = require("ramda/src/not");
var isNil_1 = require("ramda/src/isNil");
var compose_1 = require("ramda/src/compose");
var hostname_1 = require("./hostname");
var notNil = compose_1.default(not_1.default, isNil_1.default);
...
var Client = (function () {
    function Client(authorizer, host) {
        ...
        this.url = function (_a) {
            ...
            return compose_1.default(when_1.default(function () { return notNil(qs); }, function (finalUrl) { return finalUrl + "?" + qs_1.stringify(qs); }), when_1.default(function () { return notNil(action); }, function (resourceUrl) { return resourceUrl + "/" + action; }), when_1.default(function () { return notNil(params.id); }, function (collectionUrl) { return collectionUrl + "/" + params.id; }), function (hostname) { return "" + hostname + S(base).template(params, '{', '}').s; })(_this.host);
        };
